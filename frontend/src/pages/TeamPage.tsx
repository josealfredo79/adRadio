    ...
    <>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <h2 className="mb-4 font-semibold text-gray-900 flex items-center gap-2">
          <UserPlus className="h-5 w-5 text-brand-600" /> Invitar miembro
        </h2>
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          <h2 className="font-semibold text-gray-900 flex items-center gap-2">
            <Users className="h-5 w-5 text-gray-400" /> Miembros del equipo
          </h2>
        </div>
        {isLoading ? (
              ...
              <li key={m.id} className="flex items-center justify-between px-6 py-4">
                ...
                <div className="flex items-center gap-3">
                  <select
                    ...
                    className="rounded-lg border border-gray-200 px-2 py-1 text-xs focus:border-brand-500 focus:outline-none"
                  >
                    <option value="agent">Agente</option>
                    <option value="viewer">Visor</option>
                  </select>
