  ...
  return (
    <div className="relative mx-auto w-72">
      ...
      <div className="relative rounded-[2.5rem] border-4 border-white/20 bg-[#0a0a0a] shadow-2xl shadow-black/60 overflow-hidden">
        ...
        {/* Chat */}
        <div className="bg-[#ECE5DD] px-3 py-3 flex flex-col min-h-[360px] max-h-[360px] overflow-y-auto custom-scrollbar" style={{backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'20\' height=\'20\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3C/svg%3E")'}}>
  ...
  return (
    <div className="min-h-screen bg-[#06060f] text-white font-sans overflow-x-hidden">
      ...
      <section id="como-funciona" className="px-5 py-24 relative overflow-hidden">
        {/* 3D Radio sphere background reubicado */}
        <RadioSphere3D />
